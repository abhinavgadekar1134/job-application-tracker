...
const UpdateJob = (e) => {
    ...
    useEffect(() => {
        const fetchJob = async () => {
            ...
            setlocation(res.data.jobLocation)
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.put(`${BACKEND_URL}/updateJob/${id}`, setData, {
                headers: {
    ...
    return (
        <>
            ...
            <div className="max-w-2xl mx-auto mt-10 p-6 bg-white shadow-md rounded-md">
                <h2 className="text-2xl font-semibold mb-6 text-gray-800">Update Job</h2>
